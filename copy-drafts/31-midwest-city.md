# COPY DRAFT — /locations-we-serve/midwest-city/
# File: copy-drafts/31-midwest-city.md
...
<!-- NOTE: City angle = older homes, storm readiness, panels, repairs. Strong military/first-responder discount audience here — verify discount terms before publishing. -->

=== TITLE (browser tab — 50–60 chars ideal, max 60) ===
Electrician Midwest City OK | Storm Repair | Spark Shark

=== META DESCRIPTION (Google snippet — 140–160 chars) ===
Licensed residential electrician serving Midwest City, OK — panel upgrades, storm repair, generators, 24/7 emergency. Spark Shark Electric.

=== H1 (main page heading — visible on page) ===
Residential Electrician in Midwest City, OK
...
- **Storm repair** — service mast, meter base, weatherhead, and surge protection after Oklahoma severe-weather events.
...
<!-- INTERNAL LINK SUGGESTIONS:
     ...
     Neighbor cities: Del City and Oklahoma City.
     About, Reviews, Contact. -->

<!-- SCHEMA RECOMMENDATION:
     Service with areaServed: { @type: "City", name: "Midwest City" }, FAQPage, BreadcrumbList. -->
